...
if ( !class_exists( 'YITH_WCBM_Admin_Premium' ) ) {
    ...
    class YITH_WCBM_Admin_Premium extends YITH_WCBM_Admin {
        ...
        public function add_advanced_options() {
            return include 'plugin-options/advanced-options.php';
        }
        ...
        public function register_plugin_for_activation() {
            if ( !class_exists( 'YIT_Plugin_Licence' ) ) {
                require_once( YITH_WCBM_DIR . 'plugin-fw/lib/yit-plugin-licence.php' );
            }
        ...
        public function register_plugin_for_updates() {
            if ( !class_exists( 'YIT_Upgrade' ) ) {
                require_once( YITH_WCBM_DIR . 'plugin-fw/lib/yit-upgrade.php' );
            }
